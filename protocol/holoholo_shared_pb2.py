...
_TYPES = _descriptor.Descriptor(
  ...
  nested_types=[_TYPES_FORTSEARCHOUTPROTO, _TYPES_STARTGYMBATTLEOUTPROTO, _TYPES_ATTACKGYMOUTPROTO, _TYPES_BATTLEACTIONPROTO, _TYPES_BATTLELOGPROTO, _TYPES_NICKNAMEPOKEMONOUTPROTO, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
